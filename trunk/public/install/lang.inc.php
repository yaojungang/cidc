...
$lang = array(
    ...
    'tips_dbinfo' => '填写数据库信息',
    'tips_dbinfo_comment' => '',
    'tips_siteinfo_comment' => '请牢记 ' . SOFT_NAME . ' 管理员密码，凭该密码登陆 ' . SOFT_NAME . '。',
    'step_ext_info_title' => '安装成功',
    'step_ext_info_desc' => '点击进入',
    'tips_admininfo' => '填写 管理员资料',
    'ext_info_succ' => '安装成功',
    ...
    'siteinfo_username_invalid' => '管理员用户名为空，或者格式错误，请检查',
    'siteinfo_email_invalid' => '管理员Email为空，或者格式错误，请检查',
    'siteinfo_adminusername_invalid' => '管理员用户名为空，或者格式错误，请检查',
    'siteinfo_adminname_invalid' => '管理员姓名为空，请填写',
    'siteinfo_adminemail_invalid' => '管理员 Email 为空，或者格式错误，请检查',
    'siteinfo_adminpw_invalid' => '管理员密码为空，请填写',
    ...
    'password2' => '重复密码',
    'siteinfo_invalid' => '管理员信息不完整，请检查管理员账号，密码，邮箱',
    ...
    'admin_exist_password_error' => '该用户已经存在，如果您要设置此用户为微博的管理员，请正确输入该用户的密码，或者请更换微博管理员的用户名',
